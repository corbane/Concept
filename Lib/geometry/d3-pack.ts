...
import { enclose, Circle } from "./d3-enclose.js"
...
{
     next     = null as Node
     previous = null as Node
     constructor ( public _: Circle ) {}
}

export function packEnclose ( circles: Circle[] )
{
     ...
     return c.r as number
}

export function packCircles ( circles: Circle[] )
{
     packEnclose( circles );
